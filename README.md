...
```bash
npm run context:build -- OBJ-001
```

Evaluate a candidate with the ratchet rule:
...
- VS-01 Foundation: domain model, graph invariants, budgets, context builder and CI.
- VS-02 Ratchet Engine: core keep/revert decision implemented; repository mutation adapters come next.
- VS-03+ will add richer provenance, PES lifecycle adapters, certification integration and measured multi-agent execution.

See `docs/PES-V2-DESIGN.md` and `docs/MIGRATION-FROM-V1.md`.
